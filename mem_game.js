...
let userName = location.search.split('name=')[1]
let NumOfCards = location.search.split('cards=')[1] * 2

// document.write(userName)
// document.write(NumOfCards)
document.getElementById("username").innerHTML = userName;
document.getElementById("cards").innerHTML = NumOfCards;
